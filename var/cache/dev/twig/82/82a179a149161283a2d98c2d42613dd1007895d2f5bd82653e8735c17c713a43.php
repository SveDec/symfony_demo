...
class __TwigTemplate_df700aa095c6d02331c04e0b2a183bef9d6c4eb0932c11dd0070e840057e7444 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 13
        echo $this->extensions['App\Twig\AppExtension']->markdownToHtml(twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 13, $this->source); })()), "content", [], "any", false, false, false, 13));
        echo "
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["comment"]) {
            ...
            <div class=\"col-sm-9\">
                ";
            // line 51
            echo $this->extensions['App\Twig\AppExtension']->markdownToHtml(twig_get_attribute($this->env, $this->source, $context["comment"], "content", [], "any", false, false, false, 51));
            echo "
            </div>
        </div>
    ";
...
{% endblock %}
", "blog/post_show.html.twig", "/home/pi/tmp_symfony_demo/templates/blog/post_show.html.twig");
    }
}
