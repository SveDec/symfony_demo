...
class __TwigTemplate_148b82a71d26ab76903483e38e295d04d505b28da76752679d5b7db21ff5a731 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 17
        echo $this->extensions['App\Twig\AppExtension']->markdownToHtml(twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 17, $this->source); })()), "content", [], "any", false, false, false, 17));
        echo "
...
{% endblock %}
", "admin/blog/show.html.twig", "/home/pi/tmp_symfony_demo/templates/admin/blog/show.html.twig");
    }
}
